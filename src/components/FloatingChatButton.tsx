...
export const FloatingChatButton: React.FC = () => {
  ...
  const isOnLiveStreamPage = location.includes('/livestream');
  const isOnWalletPage = location.includes('/wallet');
  if (isOnMessagesPage || isOnCreatePage || isOnLiveStreamPage || isOnWalletPage) return null;
